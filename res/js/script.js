...
function checkEmail(el) {
    ...
    {
        document.getElementById('user_load').innerHTML = "<img src='http://localhost/AlgoBreizh-PHP/img/cross.png' />";
    }
}

function checkEmailExists(email) {
    var el = document.getElementById('user_load');
    var address = 'http://localhost/AlgoBreizh-PHP/signup/checkEmail/'+email;
    //console.log(address);
    el.innerHTML = "<img src='http://localhost/AlgoBreizh-PHP/img/Ajax-loader.gif' />";
...
function search_in_shop(el) {
    ...
    var turl = 'http://localhost/AlgoBreizh-PHP/shop/search';
...
function search_by_cat(el) {
    var search_form = document.getElementById('search_form');
    var turl = 'http://localhost/AlgoBreizh-PHP/category/search';
    var name = document.getElementById('p_name').value;
    var pmin = document.getElementById('pmin').value;
    var pmax = document.getElementById('pmax').value;
    var replace = document.getElementById('ajax-add');
