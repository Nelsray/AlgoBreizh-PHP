...
class admin extends Controller
{
    ...
    public function updateView($id)
    {
        ...
        echo '<div class="row">
                    <form action="http://localhost/AlgoBreizh-PHP/admin/update" class="form-horizontal" method="post" enctype="multipart/form-data">
                        <div class="col-md-6">
...
<div class="from-group" >
    ...
    public function update()
    {
        ...
        if (isset($_POST['update'])) {
            ...
            $war = $_POST['war'];
            $price = $_POST['price'];
            $dir = "/var/www/netbeans/AlgoBreizh-PHP/res/img/";
